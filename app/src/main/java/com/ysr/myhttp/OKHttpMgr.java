...
public class OKHttpMgr {
    ...
    private static OKHttpMgr mInstance;
    private OkHttpClient mOkHttpClient;
    private Handler mDelivery;
    private Gson mGson;
    private int timeout = 15;//超时时间
    private int wtimeout = 100;//上传文件的超时时间
    private String token = "";//需要传递的token
    ...
    private OKHttpMgr() {
        ...
        mOkHttpClient.setReadTimeout(wtimeout, TimeUnit.SECONDS);
    ...
    public static void postAsyn(String url, Map<String, Object> params, ResultCallback callback) {
        Log.e("--POST访问--", url + ",params " + params);
    ...
    private Request buildPostFormRequest(String url, Param[] params, Object tag) {
        ...
        if (params.length == 0)
            builder.add("key", "value");//防止在post的时候没有传递任何参数导致错误。
        else {
        ...
        token = BaseApplication.getInstance().getInfo().getToken();
        reqBuilder.url(url)
                .post(requestBody);
    ...
    public class PostDelegate {
        ...
        public void postAsyn(String url, Map<String, Object> params, final ResultCallback callback) {
            postAsyn(url, params, callback, null);
        }

        public void postAsyn(String url, Map<String, Object> params, ResultCallback callback, Object tag) {
            Param[] paramsArr = map2Params(params);
            postAsyn(url, paramsArr, callback, tag);
        }

        public void postAsyn(String url, Param[] params, ResultCallback callback) {
            postAsyn(url, params, callback, null);
        }
         ...
         * 异步的post请求
         */
        public void postAsyn(String url, Param[] params, ResultCallback callback, Object tag) {
            Request request = buildPostFormRequest(url, params, tag);
    ...
    public class UploadDelegate {
         ...
         */
        public Response post(String url, String[] fileKeys, File[] files, Map<String, Object> params, Object tag) throws IOException {

            Param[] paramsArr = map2Params(params);

            Request request = buildMultipartFormRequest(url, files, fileKeys, paramsArr, tag);
         ...
         * 同步单文件上传
         */
        public Response post(String url, String fileKey, File file, Map<String, Object> params, Object tag) throws IOException {
         ...
         * 异步基于post的文件上传:主方法
         */
        public void postAsyn(String url, String[] fileKeys, File[] files, Map<String, Object> params, ResultCallback callback, Object tag) {

            Log.d("--基于post文件上传--", url + ",params " + params + ",file " + files[0].getName());
            Param[] paramsArr = map2Params(params);
            Request request = buildMultipartFormRequest(url, files, fileKeys, paramsArr, tag);
            deliveryResult(callback, request);
        }
         ...
         */
        public void postAsyn(String url, String fileKey, File file, Map<String, Object> params, ResultCallback callback, Object tag) {
